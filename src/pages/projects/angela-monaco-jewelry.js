        ...
        <Grid mdCols="4/2">
          <MainContent>
            ...
            <p className="h3 italic">
              Angela Monaco is a Philadelphia-based jewelry designer,
              metalsmith, and entrepreneur.{" "}
            </p>
            <br />
            <h3 className="h3 black">The Problem</h3>
            <p>
              I’ve been working with Angela and her team on an ongoing basis
              since 2018 to continually improve and enhance the look and feel of
              the Shopify website for Angela Monaco Jewelry and Ritual Shoppe.
            </p>
            <br />
            <h3 className="h3 black">The Solution</h3>
            <p>
              For Angela Monaco Jewelry, I built a completely custom Shopify
            ...
            <Grid xsCols="2" data-align-center>
              ...
              <p>
                ...
                the website fit Angela’s specific needs.
              </p>
            </Grid>
            <br />
            <Grid xsCols="2" data-align-center>
