      ...
      <Splash style={{ background: "var(--gradient-gray)" }} fullWidth={true}>
        <Grid mdCols="4/2">
          <MainContent>
            ...
            <p className="h3 italic">The M. Night Shyamalan Foundation supports the grassroots efforts of emerging leaders as they work to eliminate the barriers created by poverty and social injustice in their communities.</p>
            <br />
            ...
            <p>Initially, I worked with the team at MNSF to button the website up and get it ready to accept donations for Shymaween. Once the dust had settled, we worked together to improve the website’s performance and appearance.</p>
            <br />
            <Img fluid={counter} />
            <br />
            <Grid xsCols="2" data-align-center>
              <Img fluid={blog} />
              <p>The site is built using a completely custom WordPress Theme and Advanced Custom Fields</p>
            </Grid>
            <br />
            <br />
            <Grid xsCols="2" data-align-center>
          ...
          <aside>
            ...
            <p><strong>Title</strong>: M. Night Shyamalan Foundation</p>
            <p><strong>Client</strong>: M. Night Shyamalan Foundation</p>
            <p><strong>Tools</strong>: WordPress, Webpack, ES6, Sass</p>
