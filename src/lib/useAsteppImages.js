...
export function useAsteppImages() {
  const data = useStaticQuery(graphql`
    query {
      bio: file(relativePath: { eq: "aliciastepp/astepp-bio.png" }) {
        childImageSharp {
          fluid(maxWidth: 800) {
      ...
      contactsheet: file(relativePath: { eq: "aliciastepp/astepp-contactsheet.png" }) {
        childImageSharp {
          fluid(maxWidth: 800) {
            ...GatsbyImageSharpFluid
          }
      ...
      gallery: file(relativePath: { eq: "aliciastepp/astepp-gallery.png" }) {
        childImageSharp {
          fluid(maxWidth: 800) {
            ...GatsbyImageSharpFluid
          }
      ...
      overview: file(relativePath: { eq: "aliciastepp/astepp-overview.png" }) {
        childImageSharp {
          fluid(maxWidth: 1920) {
            ...GatsbyImageSharpFluid
          }
